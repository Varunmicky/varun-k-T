...
Public Class purchasereport
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If RadioButton1.Checked = True Then
            Dim cmd As New SqlCommand("select * from neworderpurchasevb where date between @1 and @2", con)
            ...
            con.Close()
        ElseIf RadioButton2.Checked = True Then
            Dim cmd As New SqlCommand("select * from newpurchasereturn where dateofreturn between @1 and @2", con)
            cmd.Parameters.AddWithValue("@1", DateTimePicker1.Value.ToString("d"))
            cmd.Parameters.AddWithValue("@2", DateTimePicker2.Value.ToString("d"))
            con.Open()
            Dim da As New SqlDataAdapter(cmd)
